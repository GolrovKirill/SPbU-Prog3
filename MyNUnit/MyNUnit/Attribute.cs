...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MyAttribute"/> class.
    /// </summary>
    public MyAttribute()
    {
    }
    ...
    public MyAttribute(Type expected) => this.Expected = expected;
    ...
    public MyAttribute(Type expected, string ignore)
    {
